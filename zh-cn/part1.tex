...
\\[1ex]\scriptsize{}
为保证编译体验，最好使用 \href{http://www.google.com/chrome}{Google Chrome} 或 \href{http://www.mozilla.org/en-US/firefox/new/}{FireFox}浏览器。
\end{center}
\vskip 2ex
...
\footnote{第一段英文原文来自\url{http://en.wikipedia.org/wiki/Economy_of_the_United_States}}}
